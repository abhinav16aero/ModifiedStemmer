 ...
 class Stemmer {
    ...
    public static String stemInputString(String input) {
        ...
        for (int i = 0; i < length; i++) {
           ...
           if (Character.isLetter((char) ch)) {
              int j = 0;
              while (i < length && Character.isLetter((char) ch)) {
              ...
              s.stem();
              stemmedText.append(s.toString()).append(" ");
              i--;
           } else {
              stemmedText.append((char) ch);
           }
        }
     ...
     public static void main(String[] args) {
        ...
        String input = args[0]; // Read the first command-line argument
        String result = Stemmer.stemInputString(input);
        System.out.println("Stemmed Result: " + result);
     }
  }
